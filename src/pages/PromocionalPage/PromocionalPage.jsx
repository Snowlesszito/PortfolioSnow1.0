...
export default function PromocionalPage() {
  ...
  const [items, setItems] = useState({
    minecraft: getStaticGalleryItems('promocional', 'minecraft'),
    roblox:    getStaticGalleryItems('promocional', 'roblox'),
  })

  useEffect(() => {
    let active = true
    async function load(platform) {
      const loaded = await loadGalleryItems('promocional', platform)
